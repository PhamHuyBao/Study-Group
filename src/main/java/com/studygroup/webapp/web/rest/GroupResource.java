...
/**
 * REST controller for managing {@link com.studygroup.webapp.domain.Group}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class GroupResource {
        ...
        Optional<Group> result = groupRepository
            ...
            .map(existingGroup -> {
                ...
                if (group.getGroupOwnerId() != null) {
                    existingGroup.setGroupOwnerId(group.getGroupOwnerId());
                }
                ...
                if (group.getCreatedDate() != null) {
                    existingGroup.setCreatedDate(group.getCreatedDate());
                }
    ...
    public List<Group> getAllGroups(
        ...
        if ("meeting-is-null".equals(filter)) {
            log.debug("REST request to get all Groups where meeting is null");
            return StreamSupport
                .stream(groupRepository.findAll().spliterator(), false)
                .filter(group -> group.getMeeting() == null)
