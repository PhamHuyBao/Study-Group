...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEETINGNOTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MEETINGNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MEETINGNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MEETINGNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MEETINGNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MEETINGNOTE actions', async () => {
      const expectedActions = [
        {
